...
#     os.path.join("assets/score_btn.png")
# ).convert()  # convert to the same pixel format
# exit_img = pygame.image.load(
#     os.path.join("assets/exit_btn.png")
# ).convert()  # as the one you use for the final display
