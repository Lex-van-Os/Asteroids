...
def draw(rocket, asteroids, score):
    ...
    if hp >= 1:
        ...
        win.blit(score_text, (environment.environment_width  - score_text.get_width() - 10, 10))
    else:
        score_text = SCORE_FONT_ELSE.render("score: " + str(score), 1, (255, 255, 0))
        win.blit(score_text, (environment.environment_width - 450 , 150))
        game_over_text = GAME_OVER.render("game over", 1, (255, 0 , 0))
        win.blit(game_over_text, (environment.environment_width - 530 , 75))
